...
class Validator:
    ...
    def validate_required(value: Any, field_name: str) -> None:
        ...
        if value is None or (isinstance(value, str) and not value.strip()):
            raise ValidationError(
                f"El campo {field_name} es obligatorio", field=field_name
            )
    ...
    def validate_string(
        ...
        if not isinstance(value, str):
            raise ValidationError(
                f"El campo {field_name} debe ser una cadena", field=field_name
            )
    ...
    def validate_integer(
        ...
        try:
            ...
            raise ValidationError(
                f"El campo {field_name} debe ser un número entero", field=field_name
            )
    ...
    def validate_float(
        ...
        try:
            ...
            raise ValidationError(
                f"El campo {field_name} debe ser un número", field=field_name
            )
    ...
    def validate_uuid(value: Any, field_name: str) -> str:
        ...
        try:
            ...
            raise ValidationError(
                f"El campo {field_name} debe ser un UUID válido", field=field_name
            )

    @staticmethod
    def validate_date(
        value: Any, field_name: str, format_str: str = "%Y-%m-%d"
    ) -> datetime:
        """
